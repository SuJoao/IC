...
make_plot("right", "snr", "#d62728", "SNR (dB)")
make_plot("right", "rmse", "#9467bd", "RMSE", logscale=True)
make_plot("right", "max", "#8c564b", "Max Error", logscale=True)

make_plot("avg", "snr", "#2ca02c", "SNR (dB)")
make_plot("avg", "rmse", "#17becf", "RMSE", logscale=True)
make_plot("avg", "max", "#bcbd22", "Max Error", logscale=True)
